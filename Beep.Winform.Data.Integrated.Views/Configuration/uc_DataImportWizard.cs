    ...
    public partial class uc_DataImportWizard : TemplateUserControl, IAddinVisSchema
    {
        ...
        private void UpdateStageUi()
        {
            ...
            (_lblSubtitle.Text, _btnNext.Text) = _stage == Stage.Scope
                ? ("Step 1 of 2 — choose source, destination, and options.", "Run Import")
                : ("Step 2 of 2 — import progress and result.", "Finish");
        ...
        private DataImportConfiguration BuildConfig() => new()
        {
            ...
            RunMigrationPreflight = _chkPreflight.Checked
        };
        ...
        private async Task RunImportAsync()
        {
            ...
            if (editor == null)
            {
                SetStatus("IDMEEditor is not available; cannot import.");
                return;
            }
