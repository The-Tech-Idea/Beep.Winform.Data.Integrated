...
namespace TheTechIdea.Beep.Winform.Controls.Integrated.Blocks
{
    public partial class BeepBlock
    {
        ...
        private void DisposeRecordHostChildren()
        {
            if (_recordHostPanel == null)
                return;

            while (_recordHostPanel.Controls.Count > 0)
            {
                var child = _recordHostPanel.Controls[0];
                _recordHostPanel.Controls.RemoveAt(0);
                child.Dispose();
            }
        }
    }
