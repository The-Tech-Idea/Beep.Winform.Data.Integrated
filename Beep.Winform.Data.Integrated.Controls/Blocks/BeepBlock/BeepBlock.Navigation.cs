    ...
    public partial class BeepBlock
    {
        ...
        internal bool IsNavigatorCommandEnabled(string commandName)
        {
            ...
            return commandName.ToLowerInvariant() switch
            {
                ...
                "new" => !ViewState.IsQueryMode && hasLocalCommands && IsInsertAllowed(),
                "delete" => !ViewState.IsQueryMode && hasLocalCommands && hasRecords && IsDeleteAllowed(),
                "query" => hasFormsHostCommands && !ViewState.IsQueryMode && IsManagerQueryAllowed() && IsQueryAllowed(),
                "execute" => hasFormsHostCommands && ViewState.IsQueryMode && IsManagerQueryAllowed() && IsQueryAllowed(),
